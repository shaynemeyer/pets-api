...
class AppTest(unittest.TestCase):
    ...
    def test_create_app(self):
        ...
        rv = self.app.post('/apps/', data=missing_app_dict, content_type='application/json')
    ...
    def test_token_generation(self):
        ...
        rv = self.app.post('/apps/access_token/', data=missing_app_dict, content_type='application/json')
        assert "MISSING_APP_ID_OR_APP_SECRET" in str(rv.data)
